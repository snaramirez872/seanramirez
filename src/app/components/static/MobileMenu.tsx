...
export default function MobileMenu() {
    let resumeLink = "https://drive.google.com/file/d/1ibh-dYm28lZeEmhsd8bVLtcaTTZFrH4b/view?usp=sharing";
    ...
    return (
        <section className="mobile-menu-container">
            <MobileButtons linkText="Experience" url="/experience" image_url={projects} />
