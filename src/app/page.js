    ...
    <>
      ...
      <div className='homepage-desktop'>
        <div className='words'>
          ...
          <p className='right-now'>Right now I&apos;m pursuing a Software Engineering Internship with <a className='keywords' href='https://www.withsentari.com/'>Sentari AI</a>. I am also currently enrolled in a Medical Billing and Coding online course at NJCU.</p>
        </div>
